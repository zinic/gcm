...
function gcm_render_character_cp_values(character) {
    ...
    var granted_cp = character['granted_cp'];
    $('#granted_cp_value').html(granted_cp);
    gcm_log('Granted CP: ' + granted_cp);
    ...
    $('#available_cp_value').html(initial_cp + granted_cp + returned_cp - spent_cp);
}
