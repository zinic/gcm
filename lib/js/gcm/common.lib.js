...
var common = {
    ...
    notify: {
        ...
        error: function (msg) {
            common.notify.raise(msg, 'error');
        },

        warn: function (msg) {
            common.notify.raise(msg, 'warn');
        },

        info: function (msg) {
            common.notify.raise(msg, 'info');
        },

        success: function (msg) {
            common.notify.raise(msg, 'success');
        }
    },
    ...
    process_template: function (template, value_dict, prefix) {
        ...
        for (var key in value_dict) {
            ...
            if (value_type === 'string' || value_type === 'number' || value_type === 'boolean') {
                ...
                processed_template = common.process_template(processed_template, value, prefixed_key);
            }
        }
